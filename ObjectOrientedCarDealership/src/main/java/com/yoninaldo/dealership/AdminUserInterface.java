...
public class AdminUserInterface {
    ...
    public AdminUserInterface(Scanner scanner, ContractFileManager contractManager) {
    ...
    private void listLastTenContracts() {
        List<Contract> allContracts = contractManager.getAllContracts();
        ...
        List<Contract> lastTenContracts = allContracts.subList(startIndex, allContracts.size());
